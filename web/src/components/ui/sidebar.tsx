...
function SidebarHeader({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      data-sidebar='header'
      className={cn(
        'flex flex-col gap-2 border-b border-sidebar-border p-3 group-data-[collapsible=icon]:p-2',
        className
      )}
      {...props}
    />
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        'flex h-7 shrink-0 items-center rounded-md px-2 font-display text-[0.6875rem] font-semibold tracking-[0.02em] text-sidebar-foreground/60 ring-sidebar-ring outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
