...
public sealed record AiTaskClient(IChatClient Client, Guid ProviderId, string ProviderName, string Model, AiProviderCapabilities Capabilities = AiProviderCapabilities.Chat);
