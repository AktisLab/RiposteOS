...
namespace RiposteOS.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260722103000_AddStoredAiProviderApiKeys")]
    partial class AddStoredAiProviderApiKeys
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RiposteOS.Core.Ai.AiExecutionPayload", b =>
                {
                    ...
                    b.ToTable("ai_execution_payloads", "ai");
                });
            ...
            modelBuilder.Entity("RiposteOS.Core.Ai.AiExecutionPayload", b =>
                {
                    b.HasOne("RiposteOS.Core.Ai.AiExecutionLog", null)
                        .WithOne()
                        .HasForeignKey("RiposteOS.Core.Ai.AiExecutionPayload", "ExecutionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
