...
namespace RiposteOS.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260720085234_AddAiExecutionLogs")]
    partial class AddAiExecutionLogs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RiposteOS.Core.Ai.AiExecutionLog", b =>
                {
                    ...
                    b.Property<Guid?>("DocumentClassificationId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DocumentClassificationId")
                        .HasDatabaseName("ix_ai_execution_logs_classification_id");

                    b.HasIndex("DocumentProcessingRunId")
                        .HasDatabaseName("ix_ai_execution_logs_processing_run_id");
